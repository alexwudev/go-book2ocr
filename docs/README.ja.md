...
## クイックスタート <a href="#目次">⬆</a>

### 方法 A：ビルド済みリリースをダウンロード（推奨） <a href="#目次">⬆</a>
...
### 1. Google Cloud Vision API キー <a href="#目次">⬆</a>
...
### 2. CJK フォント（中国語・日本語・韓国語 OCR 用） <a href="#目次">⬆</a>
...
### Windows（ネイティブ） <a href="#目次">⬆</a>

```batch
build.bat
```

### WSL（Windows 向けクロスコンパイル） <a href="#目次">⬆</a>
