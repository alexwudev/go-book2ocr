...
### 1. Google Cloud Vision API 金鑰 <a href="#目錄">⬆</a>
...
### 2. CJK 字體（中日韓 OCR 用） <a href="#目錄">⬆</a>
...
### Windows（原生編譯） <a href="#目錄">⬆</a>

```batch
build.bat
```

### WSL（交叉編譯為 Windows） <a href="#目錄">⬆</a>
