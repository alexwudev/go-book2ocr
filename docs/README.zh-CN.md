...
<h2 id="工作流程">工作流程 <a href="#目录">⬆</a></h2>
...
<h3 id="批量重命名">批量重命名 <a href="#目录">⬆</a></h3>
- 从文件夹导入扫描图片，附带缩略图预览
...
<h3 id="图片转换">图片转换 <a href="#目录">⬆</a></h3>
- 按百分比（1-99%）批量缩放图片
- 保留 EXIF 方向信息
...
<h3 id="方式-b从源码构建">方式 B：从源码构建 <a href="#目录">⬆</a></h3>
...
cd go-book2ocr
scripts\build.bat          # Windows 环境
# 或
./scripts/build.sh         # WSL 环境（交互式菜单：Windows 或 Linux）
```
...
<h3 id="典型工作流程">典型工作流程 <a href="#目录">⬆</a></h3>
...
<h3 id="重命名标签页">重命名标签页 <a href="#目录">⬆</a></h3>
...
<h3 id="转换标签页">转换标签页 <a href="#目录">⬆</a></h3>
...
<h3 id="1-google-cloud-vision-api-密钥">1. Google Cloud Vision API 密钥 <a href="#目录">⬆</a></h3>
...
<h3 id="2-cjk-字体中日韩-ocr-用">2. CJK 字体（中日韩 OCR 用） <a href="#目录">⬆</a></h3>
...
<h3 id="3-配置文件">3. 配置文件 <a href="#目录">⬆</a></h3>
...
```batch
scripts\build.bat
REM 输出：book2ocr.exe (project root)
```
...
<h2 id="文件命名规则">文件命名规则 <a href="#目录">⬆</a></h2>
